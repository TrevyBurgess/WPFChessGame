...
namespace TrevyBurgess.Games.TrevyChess.ChessGameAI
{
    using System;
    using System.Xml;
    using TrevyBurgess.Games.TrevyChess.ChessGameAI.Properties;
    ...
    {
        private XmlDocument sillyStrings;
        private Random RandJoke = new System.Random(System.DateTime.Now.Second);
        ...
        private string[] GetMessages(SillyMessagesType messageType)
        {
            ...
            if (messageNodes == null || messageNodes.ChildNodes.Count == 0)
                throw new ApplicationException(messageId + " doesn't have any messages.");
        ...
        private string[] computerInCheck;
        private string[] computerCheckMated;
        private string[] computerLossesQueen;
        private string[] computerLossesRook;
        private string[] computerLossesBishop;
        private string[] computerLossesKnight;
        private string[] computerLossesPawn;
        private string[] computerLossesPawnEnPassant;

        // Messages when comp captures pieces.
        private string[] userInCheck;
        private string[] userCheckMated;
        private string[] userLossesQueen;
        private string[] userLossesRook;
        private string[] userLossesBishop;
        private string[] userLossesKnight;
        private string[] userLossesPawn;
        private string[] userLossesPawnEnPassant;
